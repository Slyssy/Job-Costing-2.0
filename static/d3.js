...
const chartData = projectArray.map(({act_start_date, fin_est_labor_expense, fin_act_labor_expense, fin_act_revenue, fin_est_material_expense, act_material_expense, fin_est_miscellaneous_expense, act_miscellaneous_expense, fin_est_subcontractor_expense, act_subcontractor_expense}) => ({act_start_date, fin_est_labor_expense: parseFloat((fin_est_labor_expense).replace(/,/g, '')), fin_act_labor_expense: parseFloat((fin_act_labor_expense).replace(/,/g, '')), fin_act_revenue: parseFloat((fin_act_revenue).replace(/,/g, '')), fin_est_material_expense: parseFloat((fin_est_material_expense).replace(/,/g, '')), act_material_expense: parseFloat((act_material_expense).replace(/,/g, '')), fin_est_miscellaneous_expense: parseFloat((fin_est_miscellaneous_expense).replace(/,/g, '')), act_miscellaneous_expense: parseFloat((act_miscellaneous_expense)), fin_est_subcontractor_expense: parseFloat((fin_est_subcontractor_expense).replace(/,/g, '')), act_subcontractor_expense: parseFloat((act_subcontractor_expense))}));
...
const mapper = single => {
  ...
  return { year: d[0], month: d[1], fin_est_labor_expense: e , fin_act_labor_expense: a, fin_act_revenue: r, act_material_expense: m, act_miscellaneous_expense: q, act_subcontractor_expense: s, fin_est_material_expense: em, fin_est_miscellaneous_expense: eq, fin_est_subcontractor_expense: es};
}
...
const reducer = (group, current) => {
  ...
  group[i].fin_est_miscellaneous_expense += current.fin_est_miscellaneous_expense
  return group;
};
